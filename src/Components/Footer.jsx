    ...
    return (
        ...
        <Grid id='footer' verticalAlign='middle' centered columns={3}>
            ...
            <Grid.Column textAlign='center'  verticalAlign='middle' width={3}>
              <svg height = '5vw' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" onClick={this.props.handleAnimationChange('overlay')}><path fill="#F2711C" d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg> 
            </Grid.Column>
